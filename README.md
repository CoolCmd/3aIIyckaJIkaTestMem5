...
> [!NOTE]
> Номер версии Запускалки всегда можно узнать, заглянув в свойства файла `ЗапускалкаTestMem5.exe` в Проводнике. Также номер версии есть в настройках Запускалки.
